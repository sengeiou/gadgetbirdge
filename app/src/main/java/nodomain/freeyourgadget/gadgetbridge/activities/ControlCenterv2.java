...
import nodomain.freeyourgadget.gadgetbridge.util.AssetExtractor;
...
//        PyObject obj3 = py.getModule("hello").callAttr("get_list", 10.0,1.0,5.6,1.0);
//        Float r=obj3.toFloat();
//
//
//
//        // Python中调用Java类
//        //可以将返回值强行转换
//        //
//        JavaBean test=new JavaBean("test");
//        PyObject obj4 = py.getModule("hello").callAttr("get_java_bean",test);
//        //JavaBean data = obj4.toJava(JavaBean.class);
//        Integer data=obj4.toInt();
